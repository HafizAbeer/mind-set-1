...
const ClearImprovementFeedback = () => {
        ...
        >
          <div className="flex w-full gap-[20px] sm:gap-[32px] md:gap-[48px] xl:gap-[0px] h-full relative z-10 justify-center">
            ...
            <div className="w-full max-w-[956px] flex flex-col h-full gap-[16px] sm:gap-[24px]">
              ...
              <div className="flex flex-col gap-2 w-full mt-8 mb-8">
                ...
                <p className="text-[clamp(14px,3.5vw,18px)] font-inter font-medium text-[#C5C5C5] m-0">
                  Personalized feedback for Clear Improvement
                </p>
              </div>
              ...
              <div className="flex flex-col items-center justify-center w-full">
                ...
                >
                  ...
                  <div className="flex flex-col gap-4 sm:gap-6 max-w-[700px]">
                    ...
                    <p className="text-[clamp(18px,4vw,22px)] font-inter font-bold text-white/95 leading-relaxed">
                      You are on the best way to your achieved Mindset.
                    </p>
                    <p className="text-[clamp(15px,3.5vw,18px)] font-inter font-medium text-white/90 leading-relaxed">
                      So try to stabilise this state of mind trying out regular
                      exercises and reward moments.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="flex gap-4 md:flex-row md:items-center md:justify-between w-full pb-4 sm:pb-8 shrink-0">
                <button
                  type="button"
                  onClick={() => navigate("/clear-improvement")}
...
export default ClearImprovementFeedback;
