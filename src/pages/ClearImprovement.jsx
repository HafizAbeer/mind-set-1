...
const ClearImprovement = () => {
  ...
  const characteristics = [
    "Nearly no negative thoughts",
    "Much more good mode",
    "Good sleep quality",
    "Agreeable changing",
    "Less relapses",
    "Optimistic outlook",
    "Upcoming further improvements",
  ];
        ...
        >
          <div className="flex w-full gap-[20px] sm:gap-[32px] md:gap-[48px] xl:gap-[0px] h-full relative z-10 justify-center overflow-hidden">
            ...
            <div className="w-full max-w-[956px] flex flex-col h-full overflow-hidden gap-[16px] sm:gap-[24px]">
              ...
              <div className="w-full flex-1 min-h-[400px] p-4 sm:p-[32px] md:p-[40px] xl:p-[30px] border-2 border-[#D16868] rounded-[24px] relative overflow-y-auto no-scrollbar">
                ...
                <div className="flex flex-col gap-[12px] w-full">
                  {characteristics.map((item, index) => (
                    <div
                      key={index}
                      className="min-h-[64px] w-full rounded-[16px] p-[16px_20px] flex items-center justify-center transition-all font-inter font-bold text-[18px] sm:text-[20px] border-[#D16868] text-white text-center"
                      style={{
              ...
              <div className="flex gap-4 md:flex-row md:items-center md:justify-between w-full pb-4 sm:pb-8 shrink-0">
                ...
                <button
                  type="button"
                  onClick={() => navigate("/clear-improvement-feedback")}
                  className="flex-1 md:w-[calc(50%-8px)] h-[64px] rounded-[16px] flex items-center justify-center gap-[12px] p-[10px] md:p-[16px] font-inter font-bold text-white transition-all shadow-lg border-[1px] border-[#D1686880] text-[15px] md:text-[20px] active:scale-95"
                  style={{
...
export default ClearImprovement;
