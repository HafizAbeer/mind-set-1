          ...
          <div className="flex w-full gap-[20px] sm:gap-[32px] md:gap-[48px] xl:gap-[0px] h-full relative z-10 justify-center">
            ...
            <div className="w-full max-w-[956px] flex flex-col h-full gap-[16px] sm:gap-[24px]">
              <RadarPageHeader
                ...
                iconAlt="Icon"
                title="Success Gauge"
                subtitle="Slight improvement"
              />

              <div className="w-full flex-1 min-h-[300px] p-4 sm:p-[32px] md:p-[40px] xl:p-[30px] border-2 border-[#D16868] rounded-[24px] relative overflow-y-auto no-scrollbar">
              ...
              <div className="flex gap-4 md:flex-row md:items-center md:justify-between w-full pb-4 sm:pb-8 shrink-0">
                ...
                <button
                  type="button"
                  onClick={() => navigate("/slight-improvement-feedback")}
...
export default SlightImprovement;
