...
const InconstantDevelopmentFeedback = () => {
            ...
            <div className="w-full max-w-[956px] flex flex-col h-full gap-[16px] sm:gap-[24px]">
              ...
              <div className="flex flex-col gap-2 w-full mt-8 mb-8">
                ...
                <p className="text-[clamp(14px,3.5vw,18px)] font-inter font-medium text-[#C5C5C5] m-0">
                  Personalized feedback for Inconstant development
                </p>
              </div>
                ...
                >
                  ...
                  <div className="flex flex-col gap-4 sm:gap-6 max-w-[700px]">
                    ...
                    <p className="text-[clamp(16px,3.5vw,20px)] font-inter font-medium text-white/95 leading-relaxed">
                      The path to mindfulness and balance is sometimes winding and
                      arduous. Don't give up and join us in pursuing the great
                      goal of leading a happier and healthier life.
                    </p>
                    <p className="text-[clamp(15px,3.5vw,18px)] font-inter font-medium text-white/90 leading-relaxed">
                      We are happy to help you for as long as necessary.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="flex gap-4 md:flex-row md:items-center md:justify-between w-full pb-4 sm:pb-8 shrink-0">
                <button
                  type="button"
                  onClick={() => navigate("/inconstant-development")}
...
export default InconstantDevelopmentFeedback;
