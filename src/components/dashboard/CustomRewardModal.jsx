    ...
    <div className="fixed inset-0 z-[200] flex items-center justify-center p-4 bg-black/60 backdrop-blur-[4px]">
      ...
      >
        <div className="flex items-start justify-between w-full min-h-[68px]">
          <div className="flex flex-col gap-1 pr-2">
            ...
            <p className="text-[14px] sm:text-[16px] font-inter font-medium text-[#C5C5C5] leading-[20px] sm:leading-[24px] m-0">
              Reward yourself with whatever you estimate as bounty
            </p>
          </div>
          <button
            onClick={onClose}
            className="text-[#C5C5C5] hover:text-white transition-colors p-1 flex-shrink-0"
          >
            <X size={20} />
          </button>
        </div>
        ...
        <div className="flex items-center justify-end gap-3 sm:gap-[16px] w-full mt-4 sm:mt-auto">
          <button
            onClick={onClose}
            className="flex-1 sm:flex-none px-[16px] sm:px-[24px] h-[44px] sm:h-[40px] rounded-[10px] border border-[#6CB08380] text-white font-inter font-semibold text-[15px] sm:text-[16px] hover:bg-white/5 transition-all active:scale-95 bg-white/5"
            style={{
